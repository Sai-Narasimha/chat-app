...
export const UserChat = ({ chat, user }) => {
    ...
    return (
        <Stack direction='horizontal' gap={3} className="user-card align-items-center p-2 justify-content-between" onClick={() => { if (thisUserNotifications?.length !== 0) markThisUserNotificationAsRead(thisUserNotifications, notifications) }}>
